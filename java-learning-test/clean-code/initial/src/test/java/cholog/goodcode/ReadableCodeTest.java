...
public class ReadableCodeTest {
    ...
    void 어떻게_추상화하여_메서드를_작게_만들_수_있을까() {
        ...
        class LottoGame {
            int calculatePrize(
                ...
                final int count = getMatchCount(numbers, winningNumbers);
                return getWinningPrize(count);
            }
            ...
            private int getWinningPrize(final int matchCount) {
    ...
    void 어떻게_매개변수의_의미를_전달할_수_있을까() {
        ...
        Set<String> likeMenus = Set.of("쌈밥", "김치찌개", "탕수육", "비빔밥");
        Set<String> dislikeMenus = Set.of("샐러드", "파인애플 볶음밥", "미소시루", "하이라이스");
    ...
    void Collection_API를_사용하여_코드를_재사용하고_의도를_파악하기_쉽게_만들_수_없을까() {
        class Menu {
            ...
            public Menu(final List<String> menuItems) {
                ...
                final long distinctCount = menuItems.stream().distinct().count();
                if (menuItems.size() != distinctCount) {
